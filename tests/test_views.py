...
class ViewModelTest(TestCase):
    ...
    def test_post_edit_correct_context(self):        
        ...
        response = ViewModelTest.authorized_client.get(reverse("post_edit",kwargs = {'username':self.posts.author.username,'post_id':self.posts.id}) )
        form_fields={
        'text': forms.fields.CharField,
        'group':forms.fields.ChoiceField
        }        
    ...
    def test_profile_user_post(self):
        ...
        response = ViewModelTest.authorized_client.get(reverse("profile", kwargs = {'username':ViewModelTest.posts.author.username}))
        post_object = response.context['page'][0]
        post_author_0 = post_object.author
        post_pub_date_0 = post_object.pub_date
        post_text_0 = post_object.text                 
    ...
    def test_post_user_post(self): 
        ...
        response = ViewModelTest.authorized_client.get(reverse("post", kwargs = {'username':ViewModelTest.posts.author.username,'post_id':ViewModelTest.posts.id}))
        ...
        self.assertEqual(count_object, Post.objects.filter(author = ViewModelTest.posts.author).count())
